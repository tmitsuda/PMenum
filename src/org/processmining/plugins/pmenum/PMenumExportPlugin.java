...
@UIExportPlugin(description = "Export Model Transition Table", extension = "csv")
public final class PMenumExportPlugin  {
	
	@UITopiaVariant(affiliation = UITopiaVariant.EHV, author = "MITSUDA", email = "")
	@PluginVariant(requiredParameterLabels = { 0, 1 }, variantLabel = "Export Model Transition Table")
	public void export(PluginContext context, ModelTransitionTable table, File file) throws IOException {
		
		FileOutputStream out = new FileOutputStream(file);
		String outString = table.getModelTransitionTableString();
