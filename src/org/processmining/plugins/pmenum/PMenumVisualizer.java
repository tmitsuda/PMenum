...
public class PMenumVisualizer {

	protected PMenumVisualizer() {
	};

	public static PMenumVisualization getVisualizationPanel(
			DirectedGraph<?, ?> graph, 
			HeuristicsNet net, 
	...
	public static PMenumVisualization getResultsPanel(DirectedGraph<?, ?> graph,
...
//		return new ResultsPanel(jgraph);
		return new PMenumVisualization(jgraph, net, settings);
	}
	
	public static PMenumVisualization getResultsPanel(
			PluginContext context,
			ModelTransitionTable table) {
		
		return new PMenumVisualization(context, table);
	}
...
//	}
	...
	public static JComponent visualizeGraph(
		...
		return getResultsPanel(context, table);
	}
}
